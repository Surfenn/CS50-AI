...
knowledge3 = And(
    # Each person is exactly one of Knight/Knave
    Or(AKnight, AKnave),
    Not(And(AKnight, AKnave)),
    ...
    # If A said "I am a Knight", then A's truthfulness determines whether AKnight is true
    Implication(And(AKnight, ASaidKnight), AKnight),
    Implication(And(AKnave, ASaidKnight), Not(AKnight)),

    # If A said "I am a Knave", then A's truthfulness determines whether AKnave is true
